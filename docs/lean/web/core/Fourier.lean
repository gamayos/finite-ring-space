/-! FrcCore/Fourier.lean for the live instance: the core module with the 7 modules it rests on inlined
(Nat, Pigeonhole, Shell, Frame, Orbit, Sum, Meridian); plain Lean, no Mathlib, no axioms. Generated by make_core_web.py — edit the modules, not this file.
...
#print axioms FRC.Fourier.p06009
#print axioms FRC.Fourier.p06010
