/-! FrcCore/Algebra.lean for the live instance: the core module with the 8 modules it rests on inlined
(Nat, Pigeonhole, Shell, Frame, Orbit, Sum, Instances, Poly); plain Lean, no Mathlib, no axioms. Generated by make_core_web.py — edit the modules, not this file.
...
#print axioms FRC.Algebra.row_C2
