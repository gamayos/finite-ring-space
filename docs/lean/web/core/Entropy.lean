/-! FrcCore/Entropy.lean for the live instance: the core module with the 12 modules it rests on inlined
(Nat, Pigeonhole, Shell, Frame, Orbit, Sum, Meridian, Instances, Poly, Algebra, Epi, Dimensions); plain Lean, no Mathlib, no axioms. Generated by make_core_web.py — edit the modules, not this file.
