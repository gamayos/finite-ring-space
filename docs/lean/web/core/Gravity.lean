/-! FrcCore/Gravity.lean for the live instance: the paper's core module with the 12 modules it rests on inlined
(Nat, Pigeonhole, Shell, Frame, Orbit, Sum, Meridian, Algebra, Epi, Dimensions, Instances, Entropy); plain Lean, no Mathlib, no axioms. Generated by make_core_web.py — edit the modules, not this file.
