/-! FrcCore/Gravity.lean for the live instance: the core module with the 13 modules it rests on inlined
(Nat, Pigeonhole, Shell, Frame, Orbit, Sum, Meridian, Instances, Poly, Algebra, Epi, Dimensions, Entropy); plain Lean, no Mathlib, no axioms. Generated by make_core_web.py — edit the modules, not this file.
