import Mathlib
/-! Generated by `lean/make_web.py` from `FrcLedger/Representation.lean` — one self-contained file for the Lean web editor. Edit the modules, not this file. -/

/-! FrcLedger/Representation.lean -/
