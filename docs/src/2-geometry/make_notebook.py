...
SCRIPTS = ", ".join(f"[`{n}`](https://finitering.space/src/{PKG}/{n[:-3]}.html)" for n in ["a_datum.py", "b_shell.py", "c_charts.py", "d_fourier.py"]); RUNTIME = "≈ 30 s; the block C charts are the slow part"
