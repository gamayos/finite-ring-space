...
| `FrcCore/Entropy.lean` | 14:A1, A2, B2, C5, C6, X4, B10; A2, C6, C10, B10 [value] | the congruences: `quarter_identity`, `triality_residues`, `octant_divides` (`8 ∣ 4S ⟺ 2 ∣ S`), `octant_count`, `closure_count` (`2x ≤ 2m ⟺ x ≤ m`); on every frame of even capacity `κ = 2m`: `octant_residue` (`ζ = g^m`, `ζ⁴ = −1`, `ζ⁸ = 1`), `tsirelson_square` (`(ζ + ζ⁻¹)² = 2`, `(2(ζ + ζ⁻¹))² = 8`), `two_is_square`; `nesting_bound` (`q² < p`, `p² < Ω ⇒ q⁴ < Ω`), `isPrime_of_bounded` (trial division to the square root); by `decide +kernel`: `octant17` (the octant on `𝔽₁₇`, none on `𝔽₁₃`, `𝔽₂₉`), `octant233`, `lab_carrier` (`S = 602 140` even, `≡ 1 (mod 3)`, the character `ζ₈ = 1 639 587`), `carrierLab_prime` (`2 408 561` prime), `capacity_axis`, `lab_nesting` (`37 → 1373 → 2 408 561`, `N ≤ 3`) |
