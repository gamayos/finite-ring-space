/-! FrcCore/Dimensions.lean for the live instance: the core module with the 11 modules it rests on inlined
(Nat, Pigeonhole, Shell, Frame, Orbit, Sum, Meridian, Instances, Poly, Algebra, Epi); plain Lean, no Mathlib, no axioms. Generated by make_core_web.py — edit the modules, not this file.
...
#print axioms FRC.Dimensions.row_F5
