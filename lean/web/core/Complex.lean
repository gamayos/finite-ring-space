/-! FrcCore/Complex.lean for the live instance: the core module with the 10 modules it rests on inlined
(Nat, Pigeonhole, Shell, Frame, Orbit, Sum, Instances, Poly, Algebra, Geometry); plain Lean, no Mathlib, no axioms. Generated by make_core_web.py — edit the modules, not this file.
...
#print axioms FRC.Geometry.row_B4
#print axioms FRC.Geometry.row_C2
#print axioms FRC.Geometry.row_C3
#print axioms FRC.Geometry.row_C4
