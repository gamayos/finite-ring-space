/-! FrcCore/Epi.lean for the live instance: the paper's core module with the 8 modules it rests on inlined
(Nat, Pigeonhole, Shell, Frame, Orbit, Sum, Meridian, Algebra); plain Lean, no Mathlib, no axioms. Generated by make_core_web.py — edit the modules, not this file.
