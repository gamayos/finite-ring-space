/-! FrcCore/Epi.lean for the live instance: the core module with the 10 modules it rests on inlined
(Nat, Pigeonhole, Shell, Frame, Orbit, Sum, Meridian, Instances, Poly, Algebra); plain Lean, no Mathlib, no axioms. Generated by make_core_web.py — edit the modules, not this file.
