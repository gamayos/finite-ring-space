...
predicate ledger (13 September 2026; one script since 24 September 2026). One script, `fourier.py`, five blocks, thirty-seven
...
verification", 48 predicates in blocks A–F, cited as `6:XN`; public copy `docs/6-fourier/index.html`), and the ledger's
