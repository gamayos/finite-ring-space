#!/usr/bin/env python3
"""Builds 1-algebra-main.ipynb, the package's Colab notebook: one cell per witnessed predicate of the paper's ledger, each cell addressable
...
the predicate, runs the block script of the check that decides it (`a_shell.py`, `b_numbers.py`, `c_conjecture.py` — each once per session),
