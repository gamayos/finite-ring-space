#!/usr/bin/env python3
"""Builds 10-dimensions-rows.ipynb: one cell per witnessed row of the paper's predicate ledger, each cell addressable
...
family record citing the row is listed with its verdict. Run: python3 make_rows_notebook.py  (then execute the notebook)."""
import json, re, os
import dimcommon as dcommon

PKG = "10-dimensions"; NB = f"{PKG}-rows.ipynb"; PAPER = "10"
